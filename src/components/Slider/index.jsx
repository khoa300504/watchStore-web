function Slider() {
  return (
    <div className="slider h-96 lg:h-[530px] bg-[url('~/assets/imgs/slider-bg.jpg')] bg-cover bg-no-repeat bg-center w-[94%] mb-10">
      <div className="w-full h-full flex justify-start items-center bg-gray-700 bg-opacity-15">
        <div className="mx-16 lg:mx-36 text-black text-center font-Karla">
          ...
          <div className="font-medium text-5xl mb-6">Man Watch</div>
          <div className="font-semibold text-lg mb-7">Fashionable watch for every occasion.</div>
